/**
    Blob.Farm Jelly
    A meme coin for the Blob Ecosystem
...
contract Jelly is ERC20, Ownable {
    ...
    address public revShareWallet; // Blob.Farm Address
    ...
    bool public feesRenounced = false;
    ...
    constructor() ERC20("Jelly", "JELLY") {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008 // Sepolia ... for Base: 0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24 (uniswap v2)
        );
        ...
        revShareWallet = address(0xFa4FFf6D30b44686C15cE3d5E3E983CEd8eDF308); // set as Blob Farm contract address
    ...
    function updateBuyFees(
        ...
        require(!feesRenounced, "Team has revoked fees rights");
    ...
    function withdrawStuckJelly() external onlyOwner {
    ...
    function renounceBlacklist() public onlyOwner {
     ...
     // @dev team renounce fees commands
    function renounceFees() public onlyOwner {
        buyRevShareFee = 0;
        buyLiquidityFee = 0;
        sellRevShareFee = 0;
        sellLiquidityFee = 0;
    ...
    function blacklist(address _addr) public onlyOwner {
        ...
        require(
            _addr != address(uniswapV2Pair) && _addr != address(0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008), 
    ...
    function blacklistLiquidityPool(address lpAddress) public onlyOwner {
        require(!blacklistRenounced, "Team has revoked blacklist rights");
        require(
            lpAddress != address(uniswapV2Pair) && lpAddress != address(0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008), 
            "Cannot blacklist token's v2 router or v2 pool."
        );
